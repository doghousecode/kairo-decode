...
IMPORTANT: Core AI/ML vocabulary is ALWAYS relevant even as a standalone word — never reject: model, token, prompt, embedding, agent, inference, training, fine-tuning, parameter, weight, context, attention, transformer, dataset, benchmark, latency, throughput, pipeline, skill, skills, tool, tools, memory, retrieval, grounding.
