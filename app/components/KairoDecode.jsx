...
Already in glossary (do not duplicate): ${allTermNames.join(", ")}`,
  ...
  return (
    <div className={`min-h-screen${!isDark ? " light-text-override" : ""}`} style={{
      ...
      "--card-border": isSpaghetti ? "rgba(255,255,255,0.10)" : isDark ? "rgba(255,255,255,0.09)" : isMint ? "rgba(42,58,106,0.18)" : "rgba(15,15,30,0.13)",
      ...
      "--deep-border": isDark ? "rgba(255,255,255,0.07)" : isMint ? "rgba(42,58,106,0.13)" : "rgba(15,15,30,0.1)",
