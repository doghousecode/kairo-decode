...
Already in glossary (do not duplicate): ${allTermNames.join(", ")}`,
  ...
  return (
    <div className="min-h-screen p-6" style={{ background: "linear-gradient(135deg,#080810 0%,#0d0d1c 60%,#080812 100%)", fontFamily: "'DM Sans',system-ui,sans-serif" }}>
      ...
      {/* Fixed heading */}
      <div className="fixed top-0 left-0 right-0 z-50 px-6 pt-6 pb-12" style={{ background: "linear-gradient(to bottom,#080810 55%,transparent)" }}>
      ...
      <div className="max-w-2xl mx-auto" style={{ paddingTop: "130px" }}>
        {/* Sub-header */}
        <div className="mb-8">
