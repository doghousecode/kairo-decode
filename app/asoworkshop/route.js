...
- Add categories/tags to filter terms (e.g., "basics", "technical", "safety")</pre>
    ...
    <button class="next-btn" data-reveals="section-9" onclick="revealNext(this)">Next step →</button>
  </div>
  ...
  <div class="section section-locked" id="section-10">
    ...
    <button class="next-btn" data-reveals="section-11" onclick="revealNext(this)">Next step →</button>
  </div>
