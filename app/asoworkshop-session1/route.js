...
Save it as index.html in a folder called "ai-decoder" in my Documents folder.</pre>
      <p style="margin-top: 0.75rem; font-size: 10pt; color: #6b7280;">⏸️ <em>The preview pane will open up, with the first version of your Decoder page (this may take a minute or two...)</em></p>
    </div>
